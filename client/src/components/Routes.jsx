...
import GameOverview from './pages/GameDetails/GameOverView'
...
function Routes({ loggedInUser, setloginModal, setUser }) {
	return (
		<Switch>
			...
			{loggedInUser && (
				<>
					<Route exact path='/playedGames' render={() => <PlayedGames loggedInUser={loggedInUser} />} />
					<Route exact path='/createdGames' render={() => <CreatedGames loggedInUser={loggedInUser} />} />
